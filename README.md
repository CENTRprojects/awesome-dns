...
- [validns](https://codeberg.org/DNS-OARC/validns) - DNS and DNSSEC zone file validator. [![License](https://img.shields.io/badge/License-BSD_2--Clause-blue.svg)](https://opensource.org/licenses/BSD-2-Clause) ![Maintained: yes](https://img.shields.io/badge/Maintained-yes-green)
...
- [dnssoftver](https://github.com/yevheniya-nosyk/dnssoftver/) - A tool to fingerprint DNS resolver software. [![License](https://img.shields.io/badge/License-Apache_2.0-blue.svg)](https://opensource.org/licenses/Apache-2.0) ![Maintained: yes](https://img.shields.io/badge/Maintained-yes-green)
...
- [DNS Propagation Checker](https://github.com/brancogao/dns-propagation-checker) - Check DNS record propagation across multiple DNS servers worldwide with a web-based UI and REST API. [![License](https://img.shields.io/badge/License-MIT-blue.svg)](https://opensource.org/licenses/MIT) ![Maintained: yes](https://img.shields.io/badge/Maintained-yes-green)
